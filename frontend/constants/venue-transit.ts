...
> = {
  ...
  bus:     { label: 'B', fill: '#92400E', displayName: 'Bus Stop' },
  bike:    { label: 'W', fill: '#0891B2', displayName: 'Bike Share' },
  scooter: { label: 'E', fill: '#4D7C0F', displayName: 'Scooter Zone' },
  dropoff: { label: 'P', fill: '#DC2626', displayName: 'Rideshare P/U' },
};
